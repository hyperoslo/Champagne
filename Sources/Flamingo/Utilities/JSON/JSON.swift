...
extension JSON {
  ...
  */
  ...
  /**
    Creates a new instance of `JSON` from a signed integer value.

    - Parameter value: Signed integer value.
  */
  ...
  /**
    Creates a new instance of `JSON` from an unsigned integer value.

    - Parameter value: Unsigned integer value.
  */
